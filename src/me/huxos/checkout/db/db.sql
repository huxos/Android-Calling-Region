...
/*白名单*/
create table  if not exists whitelist(phone_number text primary key, phone_enable integer, sms_enable integer);
/*黑名单*/
create table  if not exists blacklist(phone_number text primary key, phone_enable integer, sms_enable integer);
/*拦截电话日志*/
